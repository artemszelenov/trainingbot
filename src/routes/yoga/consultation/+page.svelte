...
<ServicePage service_slug="yoga-consultation">
  ...
  <main class="container prose">
    ...
    <ul>
      ...
      <li>
        Проблемы по-женски (боли в критические дни; ПМС; эндометриоз,
        поликистоз, миома)
      </li>
      <li>Беременность</li>
    ...
    <ol>
      ...
      <li>
        Подробный разбор вашего запроса и предложения вариантов его решения
      </li>
